...
<div class="navbar bg-primary fixed z-50 shadow-lg w-screen">
  ...
  <div class="navbar-end">
    <div
      ...
      data-tip="設定"
    >
      <label class="btn btn-circle btn-ghost btn-sm p-1 -mb-2" for="settings-modal">
        <!-- 設定アイコン -->
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="stroke-primary-content stroke-0"
