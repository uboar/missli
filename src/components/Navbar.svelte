...
<div class="navbar bg-primary fixed z-50">
    <div class="flex-1">
        <div class="btn btn-ghost normal-case text-xl">MissLI</div>
    </div>
    <div class="flex-none">
      <a class="btn btn-circle btn-ghost btn-sm" href="https://github.com/uboar/missli" target="_blank" rel="noreferrer">
